...
export default function Register() {
  ...
  const handleOtpSubmit = async (e) => {
    ...
    const googleregister = async () => {
        console.log("trying t log in by google");
      ...
      navigate("/");
            ...
            console.error("Error in google register:", error.response?.data);
      setMessage(error.response?.data?.message)
        }
    }
    const githubregister = async () => {
        console.log("Register by gthub");
      ...
      navigate("/");
            ...
            console.error("Error in github register:", error.response?.data);
      setMessage(error.response?.data?.message)
        }
    }
  return (
    <div className="flex items-center justify-center min-h-screen bg-gray-100">
      <div className="bg-white shadow-lg rounded-lg p-8 max-w-md w-full">
        ...
        <div className="mt-4 text-center">
          <p>Or register with:</p>
          <GoogleOAuthProvider clientId='593506999372-e1bj3nlc3ec11obivl7q9o7n1kah9tf2.apps.googleusercontent.com'>
      <div className="App">
        <GoogleSignIn />
      </div>
    </GoogleOAuthProvider>
